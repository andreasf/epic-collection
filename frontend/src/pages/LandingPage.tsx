        ...
        return (
            <div className="landing-page">
                    ...
                    <div className="content">
                        ...
                        <div className="introduction">
                            <p>
                                ...
                                of 10000 tracks. It interactively moves albums to playlists, keeping all your music around.</p>
                        </div>
                        <div className="login">
                ...
                <div className="fold"> 
                    ...
                    <div>
                        <p>
                            Your Spotify account has both a library of saved tracks and albums, <i>and</i> a set of playlists. That's right,
